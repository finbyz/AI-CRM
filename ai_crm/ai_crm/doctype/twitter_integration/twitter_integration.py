...
class TwitterIntegration(Document):
    ...
    def _refresh_access_token(self):
        ...
        try:
            ...
            token_data = {"grant_type": "refresh_token", "refresh_token": self.refresh_token}
    ...
    def _get_bearer_headers(self):
        ...
        if self.token_expires_at:
            ...
            buffer_time = now_datetime() + timedelta(minutes=5)
            if buffer_time >= token_expiry:
                frappe.log_error(message="Token expiring soon, attempting refresh", title="Twitter Token Refresh")
